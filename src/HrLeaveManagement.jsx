...
// const [lopSuccessMessage, setLopSuccessMessage] = useState("");
//   /* ================= FETCH LEAVES ================= */
...
//   setLeaveNameError(""); // Clear error while typing
// }
...
//   hasError = true;
// } else if (form.leaveName.trim().length > 32) {
//   setLeaveNameError("Leave name cannot exceed 32 characters");
//   hasError = true;
// }
...
// setLopSuccessMessage("LOP recorded successfully and email notification sent!");
// showNotification("LOP recorded successfully!", "success");
...
//             {/* {lopSuccessMessage && (
//   <div className="lop-success-banner">
//     ✓ {lopSuccessMessage}
//   </div>
// )} */}
...
//   {lopSuccessMessage && (
//     <div className="lop-success-banner-inline">
//       ✓ {lopSuccessMessage}
//     </div>
//   )}
...
if (name === "leaveName") {
  ...
  // handleDelete is unused; removed to resolve lint error
...
showNotification("LOP recorded successfully!", "success");
  ...
  /* ================= STATISTICS ================= */
  // Removed unused totalLeaveTypes and totalDaysAvailable variables
  ...
  return (
    <div className="hr-leave-container">
      {/* Notification Toast */}
      {notification.show && (
        <div ref={notificationRef} className={`notification notification-${notification.type}`}>
          <span className="notification-icon">
            {notification.type === "success" ? "✓" : "⚠"}
          </span>
          <span className="notification-message">{notification.message}</span>
      ...
      {activeTab === "lop" && (
        <div className="leave-form-container">
          ...
          <form onSubmit={submitLOP} className="lop-form">
            <div className="form-group">
              <label htmlFor="userName">Employee Id <span className="required">*</span></label>
              <input
                id="userName"
                type="text"
                name="userName"
